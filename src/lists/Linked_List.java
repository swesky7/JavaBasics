...
public class Linked_List {
	...
	public static void main(String[] args) {
		 ...
		 * 6. Peek and Poll Methods- peek gives values at head and tail , poll also gives values but removes them from the list
		 */
		...
		//list.set(2, 3.3);
		//System.out.println(list.get(2));
		//list.add(3, 9.8); // will add at that index
		//list.clear();
		//list.remove(0);
		//list.remove(1.6); //remove by value or index
